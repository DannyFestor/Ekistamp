<template>
    ...
    >
        ...
        <section class="flex flex-col">
            ...
            <NavLink :href="route('admin.prefectures.index')"
                     v-if="['all', 'show_prefecture'].some(permission => $page.props.auth.can.includes(permission))"
            ...
            <NavLink :href="route('admin.companies.index')"
                     v-if="['all', 'show_company'].some(permission => $page.props.auth.can.includes(permission))"
