<template>
  ...
  <section class="my-4 text-2xl">Create New Stamp</section>

  <form @submit.prevent="storeStamp" class="flex flex-col space-y-4">
    <FormTextSearch
      id="station_id"
